...
To install place the "canonical3" directory inside
...
The "canonical3" directory contains the database of all three-dimensional
canonical Fano polytopes. This classification is derived in:

    [Kas]  Alexander M. Kasprzyk, "Canonical toric Fano threefolds", to appear
             in the Canadian Journal of Mathematics. arXiv:0806.2604v2

Each entry in the database has been assigned a unique ID in the range 1..674688.
These ID correspond with the IDs on the Graded Ring Database:

    [GRDB] http://grdb.lboro.ac.uk/forms/toricf3c

The format of the files in the "canonical3" directory is deliberately
transparent; you are welcome to use this data for your own work, provided that
a reference to the paper [Kas] and a link to [GRDB] is included.
