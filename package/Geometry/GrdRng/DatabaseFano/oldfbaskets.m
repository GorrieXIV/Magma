...
/////////////////////////////////////////////////////////////////////
// First the alternative methods of calling the intrinsic.

intrinsic FanoBaskets(n::RngIntElt,f::RngIntElt: Order:="default") -> SeqEnum
{}
    return FanoBaskets(n,0,f: Order:=Order);
end intrinsic;

intrinsic FanoBaskets(B::SeqEnum,f::RngIntElt: Order:="default")
		-> SeqEnum
{}
    return FanoBaskets(B,0,f: Order:=Order);
end intrinsic;

intrinsic FanoBaskets(n::RngIntElt,g::RngIntElt,f::RngIntElt:
		Order:="default") -> SeqEnum
{}
    B := FanoIsolatedBaskets(n,f);
    return FanoBaskets(B,g,f: Order:=Order);
end intrinsic;
...
intrinsic FanoBaskets(B::SeqEnum,g::RngIntElt,f::RngIntElt:Order:="default")
		-> SeqEnum
...
procedure cond_A3pos(~BB,f,g)
    vprintf User1: "Imposing A^3 > 0 ...\n";
    nBB := #BB;
    BB := [ B : B in BB | fano_degree_g(g,f,B) gt 0 ];
    vprintf User1: "\treduced from %o to %o baskets\t",nBB,#BB;
end procedure;

procedure cond_kawamata(~BB,f,g)
