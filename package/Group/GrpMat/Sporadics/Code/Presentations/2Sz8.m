...
/* presentation on standard generators for 2.Sz8 */

Presentation2Sz8 := function (G : UserGenerators := [], Projective := false)
   ...
   relators := {x^2,y^4,(x*y)^5,(x*y^2)^7,(x*y*x*y^(-1)*x*y^2)^7};
