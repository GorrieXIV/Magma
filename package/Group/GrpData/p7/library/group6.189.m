...
Group6_189 := function (p: Process:=true, Select:=func<x|true>)

if p lt 5 then "6.189 valid only for p>3"; return false; end if;
...
GR:=Group<a,b,c,d,e,f|d=a^p,e=(b,a,a),f=(e,a),(b,a,b), (c,a), (c,b), d^p, b^p=e*f^-1, 
                            c^p=f>;
ProcessPresentation (~L, GR, p, class, ~Nmr: Process := Process, Select := Select);
GR:=Group<a,b,c,d,e,f|d=a^p,e=(b,a,a),f=(e,a),(b,a,b), (c,a), (c,b), d^p=f, 
                            b^p=e*f^-1, c^p=f>;
...
vprint Orderp7, 1: "Group 6.189 has",count,"descendants of order p^7 and p-class 4";
