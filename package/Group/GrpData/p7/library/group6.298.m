...
Group6_298 := function (p: Process:=true, Select:=func<x|true>)

if p lt 5 then "6.298 valid only for p>3"; return false; end if;
...
vprint Orderp7, 1: "Group 6.298 has",count,"descendants of order p^7 and p-class 4";
