...
Group6_154 := function (p: Process:=true, Select:=func<x|true>)

if p lt 5 then "6.154 valid only for p>3"; return false; end if;
...
GR:=Group<a,b,c,d,e,f|d=(b,a,a),e=(b,a,b),f=(b,a,a,a),(c,a)=d*f^r, (c,b), a^p=e^w, b^p, c^p>;
ProcessPresentation (~L, GR, p, class, ~Nmr: Process := Process, Select := Select);
GR:=Group<a,b,c,d,e,f|d=(b,a,a),e=(b,a,b),f=(b,a,a,a),(c,a)=d*f^r, (c,b), a^p=e^w, 
                      b^p=f, c^p>;
ProcessPresentation (~L, GR, p, class, ~Nmr: Process := Process, Select := Select);
count:=2;
...
vprint Orderp7, 1: "Group 6.154 has",count,"descendants of order p^7 and p-class 4";
